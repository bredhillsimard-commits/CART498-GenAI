...
3. **Head fragments.** Each "head" (birdcage + goldfish, fishbowl + canary, feathered goldfish in the cage + bird perched on top) is generated separately, cut out as an oval with a paper border and shadow, and pasted on the neck.

AI use disclosure. Claude (Anthropic, model claude-opus-5-5, via claude.ai) was used to read the brief, develop the concept, write the prompts and the diffusers/PIL code, run the notebook in Colab, and draft this README. I reviewed the outputs, chose the final images, and directed revisions. The essay is my own writing.
